-- Script SQL corrigé pour résoudre les problèmes de connexion Payhuk
...
SELECT 
    'Profiles crees' as status,
    COUNT(*) as count
FROM public.profiles;

-- 12. Test simple d'accès
SELECT 
    'Test acces' as test,
    CASE 
        WHEN auth.uid() IS NOT NULL THEN 'Utilisateur connecte'
        ELSE 'Aucun utilisateur connecte'
    END as result;
